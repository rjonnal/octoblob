...
for arg in args:
    try:
        ...
        try:
            ...
            assert len(glob.glob(os.path.join(arg,'*.npy')))>0
            bscan_folders.append(arg)
...
def usage():
    print('Usage:')
    print('\t python org_flash_block_analysis.py paths*/to*/phase_ramp_npy start_index end_index')
